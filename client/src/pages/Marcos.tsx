...
import { usePainelData, MarcoStats, ClienteMarcoDetalhado } from '@/hooks/usePainelData';
...
export default function Marcos() {
  ...
  let filteredClientes = data?.clientesMarcoDetalhado || [];
            ...
            <div className="flex items-start justify-between mb-3">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <span
                    className="inline-flex items-center justify-center font-bold text-xs w-6 h-6 rounded-full shrink-0"
                    style={{
                  ...
                  <h3 className="font-semibold text-gray-800 text-sm">{cliente.nome}</h3>
                </div>
