    ...
    <div className="min-h-screen md:ml-20" style={{ backgroundColor: '#F5F7FA' }}>
      ...
      <header className="sticky top-0 z-40 border-b" style={{ backgroundColor: '#001F3F', borderColor: '#E0E8F0' }}>
        <div className="px-6 py-4">
          ...
          {/* Filtro por Mês e Ano */}
          <div className="mb-4 p-4 bg-gray-800 rounded-lg border" style={{ borderColor: '#00DD00' }}>
            <div className="flex items-center gap-4 flex-wrap">
              <div className="flex items-center gap-2">
                <Calendar className="w-4 h-4 text-white" />
                <label className="text-sm font-semibold text-white">Selecionar Período:</label>
              </div>
              ...
              <div className="flex gap-2 items-center">
                <button
                  ...
                  style={!showAllMonths ? { borderColor: '#E0E8F0' } : {}}
                >
                  Todos
                </button>
                <div className="flex flex-wrap gap-1">
                  {Array.from({ length: 12 }, (_, i) => i + 1).map(month => (
                    <button
                      ...
                      style={!selectedMonths.has(month) ? { borderColor: '#E0E8F0' } : {}}
              ...
              <div className="flex gap-2 items-center">
                <button
                  ...
                  style={!showAllYears ? { borderColor: '#E0E8F0' } : {}}
                >
                  Todos
                </button>
                <select
                  ...
                  className="px-3 py-2 border border-gray-300 rounded-md text-sm text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 disabled:opacity-50 disabled:cursor-not-allowed"
